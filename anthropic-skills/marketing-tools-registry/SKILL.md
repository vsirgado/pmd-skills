...
description: A centralized registry of marketing tools that helps AI agents quickly identify available platforms, understand their capabilities, and determine the best integration method (API, MCP, CLI, or SDK) for each tool.
---
